...
constexpr int ESP_NOW_NETWORK_MODE = 0; // 0: Through Same WiFi Network, 1: Point-to-Point

// Declare the MAC address of the slave and master devices for ESP-NOW communication
uint8_t localMacAddress[] = {0xB0, 0x81, 0x84, 0xA9, 0x1F, 0x3C};  // the MAC address of the slave device (remote one) B0:81:84:A9:1F:3C
...
void setup()
{
  ...
  // Print local MAC address for debugging
