...
// Declare the MAC address of remote devices for ESP-NOW communication
uint8_t remoteMacAddress[] = {0xB0, 0x81, 0x84, 0xA8, 0xF1, 0xBC}; // !! You must change to your peer's ESP32 MAC Address
